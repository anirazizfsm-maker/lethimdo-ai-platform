      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-bold text-xl px-3 py-2 rounded inline-block mb-4">
              Lethimdo
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Professional API Integration Platform for Bangladesh Freelance Agencies. 
              Earn in USD while reducing operational costs by 90%.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><Link to="/api" className="text-base text-gray-300 hover:text-white">API Status</Link></li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            <span className="text-gray-400 text-sm">Made with ❤️ for Bangladesh Freelance Agencies</span>
          </div>
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2025 Lethimdo. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
